...
function SignUp({ history }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      success ? setAlertType("success") : setAlertType("error");
      setIsLoading(false);
      e.target.reset();
    } catch (error) {
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <div className="max-w-sm mx-auto">
                ...
                {alertType === "success" ? (
                  <div
                    className="bg-green-100 border-l-4 border-green-500 text-green-700 p-3 mb-3"
                    role="alert"
                  >
                    <p>
                  ...
                  alertType && (
                    <div
                      className="bg-red-100 border-l-4 border-red-500 text-red-700 p-3 mb-3"
                      role="alert"
                    >
                      <p>{error ? error : `Email Already Registered`}</p>
                    </div>
                  )
                )}
